...
mycon = sql.connect(host="localhost", user="root", password="environ@129", database="nbank")
mycur = mycon.cursor()
while True:
    print("\n")
    print("_________________________")
    print("*******  Welcome To Najjarbattu Bank Of India  *******")
        ...
        if (ch >= 3):
            ...
            while True:
                try:
                    ...
                    print(
                        "Password should contain at least 1 upper case, 1 Lower Case , 1 Special Character  and Password Must Contain atleast 6 character")
                except KeyError:
                    print(
                        "Password should contain at least 1 upper case, 1 Lower Case , 1 Special Character  and Password Must Contain atleast 6 character")
                ...
                if (ch1 == 1):
                    ...
                    while True:
                        ...
                        try:
                            ...
                            print("_________________")
                            print("      *OOPS!! That's Was an invalid input*    ")
                            print("_________________")
                            continue
                        break
                    if (ch2 == 1):
                    ...
                    print("\n")
                    print("___________________________")
                    print("****Thanks For Choosing Najjarbattu Bank Of India ******")
                    print("__________________________")
                    exit()
