...
while running:
    ...
    if not game_over:
        ...
        # Draw progress bars
        pygame.draw.rect(
            screen, BLUE, (100, 20, old_kanye.score * (400 / WINNING_SCORE), 10)
        )
        pygame.draw.rect(
            screen, RED, (100, 40, new_kanye.score * (400 / WINNING_SCORE), 10)
        )

        # Labels
        font = pygame.font.SysFont("Arial", 18)
        screen.blit(font.render(f"Old Kanye: {old_kanye.score}", True, BLUE), (20, 15))
        screen.blit(font.render(f"New Kanye: {new_kanye.score}", True, RED), (20, 35))
